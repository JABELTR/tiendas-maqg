// src/main/java/com/tienda/controller/CruceRedebanController.java
package com.tienda.controller;

import com.tienda.dto.CruceRedebanRow;
import com.tienda.service.CruceRedebanService;
...
@RestController
@RequestMapping("/cruce-redeban")
@CrossOrigin(origins = "*")
public class CruceRedebanController {

    private final CruceRedebanService service;

    public CruceRedebanController(CruceRedebanService service) {
    ...
    public ResponseEntity<?> upload(
        ...
        try {
            List<CruceRedebanRow> resp = service.ejecutarDesdeArchivo(file, fechaInicio, fechaFin, separator);
...
public void exportToExcel(
    ...
    try {
        ...
        response.setHeader("Content-Disposition", "attachment; filename=cruce-redeban.xlsx");
